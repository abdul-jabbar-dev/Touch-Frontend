  ...
  return (
      <main className="flex w-full h-screen shadow-lg rounded-3xl">
          ...
          <section className="flex flex-col pt-3 w-4/12 bg-gray-50 h-full overflow-y-scroll">
              ...
              <ul className="mt-6">
                  <li className="py-5 border-b px-3 transition hover:bg-cPrimary-600">
                  ...
                  <li className="py-5 border-b px-3 bg-cPrimary-800 text-white">
                      <a href="#" className="flex justify-between items-center">
                          <h3 className="text-lg font-semibold">Akhil Gautam</h3>
          ...
          <section className="w-8/12 px-4 flex flex-col bg-white rounded-r-3xl">
              ...
              <section>
                  <h1 className="font-bold text-cPrimary-900 text-2xl">We need UI/UX designer</h1>
                  ...
                  <ul className="flex space-x-4 mt-12">
                      ...
                      <li
                          className="w-10 h-10 border rounded-lg p-1 cursor-pointer transition duration-200 text-cPrimary-800 hover:bg-blue-100">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
              ...
              <section className="mt-6 border rounded-xl bg-gray-50 mb-3">
                  ...
                  <div className="flex items-center justify-between p-2">
                      ...
                      <button className="bg-cPrimary-800  active:bg-cPrimary-900  text-white px-6 py-2 rounded-xl">Reply</button>
                  </div>
              </section>
          </section>
      </main>   
